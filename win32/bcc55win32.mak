################################################################################
#
# Borland MAKE Makefile for PDCurses library - Win32 BC++ 5.5+
#
# Usage: make -f [path\]bcc55win32.mak [-DDEBUG] [target]
#
...
CCLIBS		=$(CCLIBDIR)\import32.lib $(CCLIBDIR)\cw32.lib $(CCLIBDIR)\uuid.lib
